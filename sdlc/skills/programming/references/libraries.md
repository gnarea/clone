...
- Everything outside that surface MUST carry the strictest visibility the language offers, and the language's explicit-API mode MUST be enabled where one exists.
...
- No dependency's types MAY appear in the public surface.
